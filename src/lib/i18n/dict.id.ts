...
export const ID: Record<string, string> = {
  ...
  "Active Team Members": "Anggota Tim Aktif",
  "Today's Jobs": "Pekerjaan Hari Ini",
  ...
  "Team Member Load": "Beban Anggota Tim",
  "Team Score": "Skor Tim",
  ...
  "Flow: Team Member → Manager → Owner": "Alur: Anggota Tim → Manajer → Pemilik",
  ...
  "Archive instead": "Arsipkan saja",
  "Delete not allowed": "Tidak boleh dihapus",
  ...
  "Repair order restored": "Order dipulihkan",
  "Repair order permanently deleted": "Order dihapus permanen",
  "Override recorded in audit log": "Override tercatat di log audit",
  "Record override": "Catat override",
};
