...
export const ZH: Record<string, string> = {
  ...
  "Flow: Team Member → Manager → Owner": "流程：团队成员 → 经理 → 老板",
  ...
  Archived: "已归档",
  "repair orders": "张工单",
  "No repair orders yet. Tap \"+ New\" to create the first one.": "暂无工单，点击 \"+ 新建\" 创建首张。",
  "No archived repair orders.": "无已归档工单。",
  "No cancelled repair orders.": "无已取消工单。",
  New: "新建",
  "No customer": "无客户",
  Open: "打开",
  Manage: "管理",
  "Administrative actions. All changes are recorded in the audit log.": "管理操作。所有更改都会记录在审计日志中。",
  "This repair order is archived.": "此工单已归档。",
  Archive: "归档",
  Restore: "恢复",
  "Repair order archived": "工单已归档",
  "Repair order restored": "工单已恢复",
  "Repair order permanently deleted": "工单已永久删除",
  "Override recorded in audit log": "越权操作已记录到审计日志",
  "Checking…": "检查中…",
  "Delete not allowed": "无法删除",
  Delete: "删除",
  "Archive instead": "改为归档",
  "Delete permanently": "永久删除",
  "Danger zone": "危险操作区",
  "Administrative Override": "管理员越权",
  "Records the override in the permanent audit log. Does not grant the ability to edit or delete protected history — assessment versions, audit records and quotation revisions remain immutable.":
    "此操作将永久记录到审计日志。不会赋予编辑或删除受保护历史的权限——评估版本、审计记录及报价修订均保持不可更改。",
  ...
  "Permanently delete repair order": "永久删除工单",
  "This is permanent. All linked data will be removed and cannot be recovered.":
    "此操作不可撤销，所有相关数据将被清除且无法恢复。",
  ...
  "This records an override in the permanent audit log. It does not bypass protected history.":
    "此操作将记录到永久审计日志，但不会绕过受保护的历史记录。",
  "Record override": "记录越权",
};
